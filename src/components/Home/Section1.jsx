...
const Section1 = () => {
  return (
    <>
      ...
      >
        <div className="min-h-screen flex items-center max-w-7xl mx-auto px-6 lg:px-8">
          <div className="w-full md:w-3/6">
            ...
            />
            <h1 className=" font-extrabold text-black xl:-translate-y-2 undefined leading-none text-[43px] lg:text-6xl xl:text-7xl 2xl:text-8xl lg:tracking-[-4px] tracking-[-2px]">
          ...
          <div className="w-full md:w-3/6 hidden lg:block">
            <img
              ...
              className="absolute top-[60%] 2xl:top-[63%] -right-[27%] 2xl:right-[-25%] transform -translate-y-1/2 -translate-x-1/2 w-[55%] 2xl:w-[50%]"
